...
{/* <Header />  */}
  <Navbar />
    ...
    <div id="about">
    <AboutBox src={IMAGES.ABOUT}  heading='About Heading' description='Lorem ipsum is a name for a common type of placeholder text. Also known as filler or dummy text, this is simply copy that serves to fill a space without actually saying anything meaningful.
...
<Client />
  ...
  <div class="heading-section"><h2 class="testimonial-heading">Testimonial</h2>
  <Testimonial />
  </div>
</div>
